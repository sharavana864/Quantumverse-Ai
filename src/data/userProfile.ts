...
export const INITIAL_USER_PROFILE: UserProfile = {
  ...
  email: "scholar@quantumverse.io",
  authProvider: "email",
  avatar: "https://api.dicebear.com/7.x/bottts/svg?seed=QuantumScholar",
  bio: "Quantum Learner starting the journey on QuantumVerse AI.",
  title: "Quantum Novice",
  streakDays: 0,
  totalXP: 0,
  level: 1,
  githubUsername: "quantum_scholar",
  leetcodeUsername: "quantum_scholar",
